...
urlpatterns = [
    ...
    path(
        "get-public-resources/", views.get_public_resources, name="get-public-resources"
    ),
    ...
    path(
        "get-other-connection-types/",
        views.get_other_connection_types,
        name="get-other-connection-types",
    ),
    path(
        "connection_types/",
        views.get_connection_type_by_user_by_locker,
        name="get_connection_types",
    ),
    path(
        "create-new-connection/",
        views.create_new_connection,
    ...
    path(
        "get-connections-user-locker/",
        views.get_connection_by_user_by_locker,
    ...
    path(
        "get-resources-user-locker/",
        views.get_resource_by_user_by_locker,
        name="get-resources-user-locker",
    ),
    path("signup-user/", views.signup_user, name="signup_user"),
    path(
        "download-resource/<int:resource_id>/",
    ...
    path(
        "create-connection-type-and-terms/",
        views.create_connection_type_and_connection_terms,
        name="create-connection-type-and-terms",
    ),
    path(
        "freeze-unfreeze-locker/", views.freeze_or_unfreeze_locker, name="freeze_locker"
    ),
    path(
        "freeze-unfreeze-connection/",
        views.freeze_or_unfreeze_connection,
        name="freeze_connection",
    ),
    path(
        "get-guest-user-connection/",
        views.get_guest_user_connection,
        name="get_guest_user_connection",
    ),
    path(
    ...
    path(
        "get-connection-terms-for-global-template/",
        view=views.get_All_Connection_Terms_For_Global_Connection_Type_Template,
        name="get_Connection_Terms_For_Global_Template",
    ),
    path(
        "add-global-template/",
        view=views.create_Global_Connection_Type_Template,
        name="create_global_template",
    ),
    path(
        "connect-type-to-template/",
        view=views.connect_Global_Connection_Type_Template_And_Connection_Type,
        name="connect_type_to_template",
    ),
    path(
        "get-template-or-templates/",
        view=views.get_Global_Connection_Type,
    ...
    path(
        "create-global-terms/",
        view=views.create_Global_Connection_Terms,
        name="create_global_terms",
    ),
