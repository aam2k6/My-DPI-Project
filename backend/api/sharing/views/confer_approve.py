...
@extend_schema(
    summary="Approve confer resource (Guest to Host)",
    description="Confer ownership of resources from a guest locker to a host locker according to connection terms. Transfers ownership of the SNODE to the host.",
    request={
        "application/json": {
            "type": "object",
            "properties": {
    ...
    responses={
        200: OpenApiResponse(
            description="Resources conferred successfully",
            response={
                "type": "object",
                "properties": {
...
@extend_schema(
    summary="Approve confer resource (Host to Guest)",
    description="Confer ownership of resources from a host locker to a guest locker according to connection terms. Transfers ownership of the SNODE to the guest.",
    request={
        "application/json": {
            "type": "object",
            "properties": {
